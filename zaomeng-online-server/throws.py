...
class Throw():
    def __init__(self, screen, ai_settings,start_pos=10000):
        ...
        self.img_walk_right_1  = pygame.image.load("./images/thrrow_walk_right_1.png")
        self.img_walk_right_2 = pygame.image.load("./images/thrrow_walk_right_2.png")
        self.img_walk_left_1  = pygame.image.load("./images/thrrow_walk_left_1.png")
        self.img_walk_left_2 = pygame.image.load("./images/thrrow_walk_left_2.png")
        self.img_attack_left_1 = pygame.image.load("./images/thrrow_attack_left_1.png")
        self.img_attack_right_1 = pygame.image.load("./images/thrrow_attack_right_1.png")
        self.img_attack_left_2 = pygame.image.load("./images/thrrow_attack_left_2.png")
        self.img_attack_right_2 = pygame.image.load("./images/thrrow_attack_right_2.png")
        self.img_attack_left_3 = pygame.image.load("./images/thrrow_walk_left_1.png")
        self.img_attack_right_3 = pygame.image.load("./images/thrrow_walk_right_1.png")
        self.img_attack_right = pygame.image.load("./images/thrrow_attack_right.png")
        self.img_attack_left = pygame.image.load("./images/thrrow_attack_left.png")
        # 加载怪物图像并获取其外接矩形
        if(start_pos > self.screen_rect.centerx):
            self.image = pygame.image.load("./images/thrrow_walk_left_1.png")
        else:
            self.image = pygame.image.load("./images/thrrow_walk_right_1.png")
        ...
        self.fight_length = 500    #攻击半径
        self.force = ai_settings.throw_force
        # 加载怪物受伤的状态
        self.attacked = False
        #掉血动作持续时间（帧）
    ...
    def update(self,houzi,ai_settings,stones,screen):
        # 怪物受伤
        ...
        #攻击动作（投掷动作）
            ...
            if(self.fight>self.fight_time_union*2):
            ...
            if houzi.rect.centerx-self.fight_length/2 > self.rect.centerx:
                ...
                stone = Stone(ai_settings,screen,self)
                stones.add(stone)
